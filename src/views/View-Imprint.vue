<template>
  <LegalPage title="Impressum">
    ...
    <p>
      matchmaker.hr richtet sich ausschließlich an Unternehmer im Sinne des § 14 BGB
      (Personalberatungen, Recruiting-Dienstleister und Executive-Search-Firmen). Wir sind
