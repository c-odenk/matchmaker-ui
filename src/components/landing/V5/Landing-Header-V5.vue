  ...
  <header>
    ...
    <transition name="mnav">
      <nav class="mobile-nav" v-show="menuOpen">
        <a href="/#hero" @click.prevent="go('hero')">Home</a>
        <a href="/#agenten" @click.prevent="go('agenten')">Produkt</a>
        <a href="/#preise" @click.prevent="go('preise')">Preise</a>
        <div class="mobile-nav-actions">
          <button type="button" class="btn btn-ghost" @click="openDemo">Demo vereinbaren</button>
          <a class="btn btn-primary" :href="loginUrl">Anmelden →</a>
        </div>
      </nav>
    </transition>
