<template>
  <section ref="ctaSection" id="cta" class="py-12 md:py-16 lg:py-20">
      ...
      <div class="relative overflow-hidden rounded-3xl bg-dark-blue px-6 md:px-10 lg:px-14 py-10 md:py-12">
        ...
        <div class="relative z-10 flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-12">
          ...
          <div class="flex-1 flex flex-col gap-3 cta-animate-item" style="animation-delay: 0s">
            ...
            <p class="text-p-lead text-white max-w-xl">
              {{ subtext }}
            </p>
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-2 lg:flex-shrink-0 cta-animate-item" style="animation-delay: 0.15s">
            ...
            <a
              :href="loginUrl"
              class="inline-flex items-center justify-center gap-2 rounded-button px-8 py-2 text-p text-white ring-1 ring-inset ring-white/20 hover:ring-white/40 hover:bg-white/10 transition-all duration-200 md:min-w-[160px] lg:min-w-[160px] xl:min-w-[175px]"
            >
...
export default {
  ...
  data() {
    return {
      CalendarDays,
      showDemoModal: false,
      headingBefore: 'Recruiting-Prozesse automatisieren. ',
      headingAccent: 'Beratungsqualität steigern.',
