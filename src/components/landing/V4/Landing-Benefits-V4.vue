<template>
  <section ref="benefitsSection" class="pt-14 md:pt-32 lg:pt-40 pb-12 md:pb-16 lg:pb-20 bg-white overflow-x-hidden">
    <div class="mx-auto max-w-container-sm md:max-w-container-md lg:max-w-container-lg 2xl:max-w-container px-container-h">
      ...
      <div class="lg:hidden flex flex-col gap-6">
        ...
        <h2 class="text-h2-sm md:text-h2-md text-black benefits-animate-item leading-tight" style="animation-delay: 0.1s">{{ headingBefore }}<span class="text-light-blue">{{ headingAccent }}</span></h2>
      ...
      <div class="hidden lg:flex flex-row gap-16 items-center">
        ...
        <div class="lg:w-1/2 flex flex-col gap-6">
          ...
          <h2 class="text-h2-lg 2xl:text-h2-2xl text-black benefits-animate-item leading-tight" style="animation-delay: 0.1s">{{ headingBefore }}<span class="text-light-blue">{{ headingAccent }}</span></h2>
...
export default {
  ...
  data() {
    return {
      ...
      activeCardIndex: 0,
      cardRefs: [],
      headingBefore: 'KI-gestützte Automatisierung für ',
      headingAccent: 'modernes Recruiting',
