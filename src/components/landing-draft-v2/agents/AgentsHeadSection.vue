    ...
    <div class="wrap">
      <div class="sec-head mx-auto max-w-[680px] text-center mb-[88px] max-[880px]:mb-[58px]">
        ...
        <p class="text-lead text-body">
          Eine durchgängige Kette vom Lebenslauf bis zum ersten Kontakt: Jeder Agent übernimmt einen Schritt und übergibt an den nächsten. Am Ende steht ein versandfertiger Vorschlag.
        </p>
      </div>
