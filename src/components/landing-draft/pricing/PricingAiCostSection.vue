  ...
  <section class="sec bg-white">
    <div class="wrap two grid [grid-template-columns:1fr_1.1fr] gap-[52px] items-center max-[880px]:grid-cols-1 max-[880px]:gap-[30px]">
      <div class="two-text">
        ...
        <h2 class="text-section !text-[clamp(1.25rem,0.98rem+0.9vw,1.5625rem)] text-ink mt-[5px] mb-[14px]">Was kostet die KI – <span class="text-blue">und warum bleibt das kalkulierbar?</span></h2>
        ...
        <p class="text-[.95rem] text-body leading-[1.65] max-w-[620px] mt-4">
          Damit das kalkulierbar bleibt, arbeitet das Multi-Agenten-System kostenbewusst und ist je Durchlauf nach oben gedeckelt. Was ein Lauf gekostet hat, steht anschließend in der Historie.
        </p>
      </div>
