        ...
        <ol class="list-none flex flex-col">
          <li v-for="(s, i) in steps" :key="s" class="flex items-start gap-[13px] pb-[15px] last:pb-0">
            <span class="relative flex flex-col items-center shrink-0">
              <span class="w-[26px] h-[26px] rounded-full bg-navy/[0.07] text-navy flex items-center justify-center text-[.72rem] font-bold">{{ i + 1 }}</span>
              <span v-if="i < steps.length - 1" class="w-px flex-1 min-h-[16px] bg-line mt-[6px]"></span>
            </span>
